...
import com.jeecms.common.util.MyImageSingleton;
...
public class JcaptchaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			// is a good candidate!
//			AbstractManageableImageCaptchaService captchaService2 = new DefaultManageableImageCaptchaService();  
//			captchaService2.setCaptchaEngine(new MyCaptchaEngine());
			
			String captchaId = session.getSessionId(request, response);
			BufferedImage challenge = MyImageSingleton.getMyInstance().getImageChallengeForID(
