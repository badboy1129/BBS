...
public class RegisterAct {
	...
	private WebErrors validateSubmit(String username, String email,
		...
		try {
//			AbstractManageableImageCaptchaService imageCaptchaService2 = new DefaultManageableImageCaptchaService();
			//MyImageSingleton.getMyInstance().validateResponseForID
			if (!MyImageSingleton.getMyInstance().validateResponseForID(session
